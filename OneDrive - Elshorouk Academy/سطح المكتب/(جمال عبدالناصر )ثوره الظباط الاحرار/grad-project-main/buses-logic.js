document.addEventListener('DOMContentLoaded', () => {
    ...
    function getRouteColor(routeId) {
        ...
        const routeObj = routesData.find(r => String(r.id) === String(routeId));
        ...
        if (name.includes('badr') || name.includes('بدر')) return '#8b5cf6';
        if (name.includes('shorouk') || name.includes('شروق')) return '#ef4444';
        if (name.includes('madinaty') || name.includes('مدينتي') || name.includes('مدينتى')) return '#f59e0b';
