document.addEventListener('DOMContentLoaded', () => {
    ...
    function getRouteColor(routeName) {
        ...
        if (str.includes('shorouk') || str.includes('شروق')) return '#ef4444';
    ...
    function renderStationAnalytics() {
        ...
        const ZONE_COLORS = { 'cairo zone': '#3b82f6', 'el- shrouk zone': '#ef4444', 'madinty zone': '#f59e0b', 'badr zone': '#8b5cf6', 'capital zone': '#14b8a6', 'new capital zone': '#14b8a6' };
        const zoneMap = {};
        stations.forEach(s => {
